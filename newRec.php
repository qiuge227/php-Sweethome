...
<?PHP
	// 获取上级留言的编号
	$orginal = (int)$_GET['orginal']; //0原帖，1回复
	$UpperId = (int)$_GET['Upper']; //回复贴的id值
	$poster = $_GET['poster']; //留言人
	?>

<form method="POST" action="recSave.php?UpperId=<?PHP echo($UpperId); ?>" name="formadd" onsubmit = "return ChkFields()">
<input type="hidden" name="orginal" value="<?php echo("$orginal");?>">
<input type="hidden" name="upper" value="<?php echo("$UpperId");?>">
 <table align="center" border="1" cellpadding="1" cellspacing="1" width="473" bordercolor="#008000" bordercolordark="#FFFFFF" height="108">
      <tr>
		...
		<input name="uname" size="51" value="<?php echo("$poster");?>"></td>
	  </tr>
	  <tr>
	  ...
	  <tr>
        ...
        <td width="380" height="23" class="main"><input name="title" size="51"></td>
      </tr>
      <tr>
	    <td align=left bgcolor="#FFCCFF" width="77" height="43" class="main" valign="top">具体内容<font color="#FF0000">*</font></td>
        <td width="380" height="43" class="main" valign="top"><textarea rows="4" name="content" cols="50"></textarea></td>
      </tr>
		<tr>
